    ...
    $.ajax({
        ...
        success: function(html) {
            ...
            pSingleHolder.append(
                ...
                '<span class="close-portfolio-label">Back to Projects</span>' +
            ...
            $('.js-close-portfolio').on('click', function(e) {
                e.preventDefault();
                closePortfolio();
            });
        }
...
// Function to close the portfolio
...
// Add this to your existing JavaScript code, probably in main.js
